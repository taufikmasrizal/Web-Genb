...
<body>
    ...
    <div style="position: relative; background-image: url('{{ asset('thumb/' . $data->foto) }}'); height: calc(80vh - 91.9px); background-size: cover;">
        ...
        <div class="position-absolute" style="bottom: 20%; left: 5%;">
          <div class="container">
            <h1 class="font-weight-bold text-white" id="title">Tentang Kami</h1>
          </div>
        </div>
      </div>
      @endforeach
        ...
        <div class="container-fluid py-5 text-white">
            ...
            <div class="row" style="margin-top: 50px;">
                ...
                <div class="col-lg-6 d-flex justify-content-center align-items-center px-5 invisible" id="tentangFoto">
                    <img src="{{ asset('thumb/'.$data->foto) }}" class="rounded" width="100%" alt="tentang">
                </div>
            </div>
            @endforeach
        </div>
