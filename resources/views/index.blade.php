    ...
    <nav class="navbar navbar-expand-lg navbar-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item">
                <a class="nav-link text-white float-right" href="/datacollection">Data Collection</a>
              </li>
              <li class="nav-item">
    ...
    <header>
      ...
      <div style="position: relative; background-image: url('{{ asset('thumb/' . $data->foto) }}'); height: calc(100vh - 91.9px); background-size: cover;">
        <div class="position-absolute" style="bottom: 15%; left: 5%;">
          <div class="container invisible" id="headerText">
      ...
      <div class="container-fluid pt-5">
        <div id="footer" class="row invisible">
          ...
          <div class="col-lg-3 col-6 text-left text-white mb-5">
            ...
            <p class="mb-0"><a class="text-white" style="word-wrap: break-word" href="tel:{{ $data->no_kontak }}">{{ $data->no_kontak }}</a></p>
            <p><a class="text-white" style="word-wrap: break-word" href="mailto:{{ $data->email }}">{{ $data->email }}</a></p>
          </div>
