...
<div class="panel-heading">
    Form Produk Content Marketing
</div>
<div class="panel-body">
<div class="row">
<div class="col-lg-12">
<form action="{{ route('produkcontentmarketing.store') }}" method="post" enctype="multipart/form-data">
@csrf
<div class="form-group">
    <label for="Nama Produk">Nama Produk Content Marketing </label>
